<?php
	...
	if(isset($_POST["suhu__"]))
	{
		...
		{	
			$connect -> query("UPDATE probabilitas_kriteria_intensitas_cahaya SET intensitas_cahaya = '".$newDataSuhu."', jumlah_kejadian_bisa = '".$newDataJmlKejBsa."', jumlah_kejadian_tdk_bisa = '".$newDataJmlKejTdkBsa."', probabilitas_bisa = '".$newDataProbBisa."', probabilitas_tdk_bisa = '".$newDataProbTdkBisa."' WHERE id = ". $KonsId);
